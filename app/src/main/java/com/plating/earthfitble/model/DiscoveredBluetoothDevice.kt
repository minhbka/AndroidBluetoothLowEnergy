package com.plating.earthfitble.model
...
class DiscoveredBluetoothDevice : Parcelable {
    ...
    private constructor(`in`: Parcel) {
        ...
        lastScanResult =
            `in`.readParcelable(no.nordicsemi.android.support.v18.scanner.ScanResult::class.java.classLoader)
        name = `in`.readString()
        rssi = `in`.readInt()
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<DiscoveredBluetoothDevice?> = object : Parcelable.Creator<DiscoveredBluetoothDevice?>{
